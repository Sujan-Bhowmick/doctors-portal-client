...
const Contacts = () => {
  return (
    <div className="pt-24">
      ...
      >
        <div className="w-1/2">
          <h1 className="text-3xl text-primary py-10">Contact Us</h1>
      ...
      <div className="py-10">
        <h4 className="text-3xl font-bold text-center py-5">Follow Us</h4>
        {/* <h1 className="text-3xl text-primary text-center ">
          Follow us for great content on Inbound
        </h1> */}
        <div className="grid grid-flow-col gap-20 py-5 px-20">
        <>
            <svg
              width="80px"
              height="80px"
