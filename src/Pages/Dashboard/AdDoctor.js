...
const AdDoctor = () => {
     ...
     * 
     * 1. Third party storage //Free open public storage is ok for a practice project
        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    />
                    <label className="label">
                        {errors.image?.type === 'required' && <p className="lebel-text-alt text-red-500">{errors.image.message}</p>}
                    </label>
                </div>
